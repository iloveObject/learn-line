            ...
            <c:forEach items="${list}" var="student">
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <input type="text" name="stuid" class="form-control" id="inputFirstName" value="${student.stuid }" readonly="readonly">                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputLastName">班级：</label>
                    <input type="text" name="classid" class="form-control" id="inputLastName" value="${student.classid }" >                  
                </div> 
              </div>
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputUsername">姓名：</label>
                    <input type="text" name="name" class="form-control" id="inputUsername" value="${student.name }" >                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputEmail">Email</label>
                    <input type="email" name="mail" class="form-control" id="inputEmail" value="${student.mail }" >                  
                </div> 
              </div>
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputCurrentPassword">电话：</label>
                    <input type="password" name="phone" class="form-control highlight" id="inputCurrentPassword" value="${student.phone }" >                  
                </div>                
              </div>
              <div class="row form-group">
                <div class="col-lg-12 form-group">                   
                    <label class="control-label" for="inputNote">备注：</label>
                    <textarea class="form-control" name="remarks" id="inputNote" rows="8" >${student.remarks }</textarea>
                </div>
              </div>
