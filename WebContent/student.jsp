      ...
      <div class="templatemo-content col-1 light-gray-bg">
       ...
       <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">学生选课</h2>
            <p>&nbsp;</p>
            <form action="studentServelt" class="templatemo-login-form" method="post">
              <input type="hidden" name="action" value="add"/>
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputFirstName">学号：</label>
                    <input type="text" name="stuid" class="form-control" id="inputFirstName" placeholder="xx">                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputLastName">班级：</label>
                    <input type="text" name="classid" class="form-control" id="inputLastName" placeholder="请输入您的班级号">                  
                </div> 
              </div>
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputUsername">姓名：</label>
                    <input type="text" name="name" class="form-control" id="inputUsername" placeholder="请输入您的姓名">                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputEmail">Email</label>
                    <input type="email" name="mail" class="form-control" id="inputEmail" placeholder="admin@163.com">                  
                </div> 
              </div>
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputCurrentPassword">电话：</label>
                    <input type="password" name="phone" class="form-control highlight" id="inputCurrentPassword" placeholder="*********************">                  
                </div>                
              </div>
              <div class="row form-group">
                <div class="col-lg-12 form-group">                   
                    <label class="control-label" for="inputNote">备注：</label>
                    <textarea class="form-control" name="remarks" id="inputNote" rows="8" placeholder="如果需要的话，你可以留下你的足迹。"></textarea>
                </div>
              </div>
