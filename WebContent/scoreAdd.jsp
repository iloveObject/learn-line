      ...
      <div class="templatemo-content col-1 light-gray-bg">
       ...
       <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">添加学生成绩</h2>
            <p>&nbsp;</p>
             <form action="scoreServelt" class="templatemo-login-form" method="post">
              ...
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <input type="text" name="stuid" class="form-control" id="inputFirstName" >                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputLastName">姓名：</label>
                    <input type="text" name="name" class="form-control" id="inputLastName" >                  
                </div> 
              </div>
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputUsername">班级：</label>
                    <input type="text" name="classid" class="form-control" id="inputUsername" >                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputEmail">平时成绩：</label>
                    <input type="text" name="normal_score" class="form-control" id="inputEmail" >                  
                </div> 
              </div>
               <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputUsername">期中成绩：</label>
                    <input type="text" name="middle_score" class="form-control" id="inputUsername" >                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputEmail">期末成绩：</label>
                    <input type="text" name="end_score" class="form-control" id="inputEmail" >                  
                </div> 
              </div>
